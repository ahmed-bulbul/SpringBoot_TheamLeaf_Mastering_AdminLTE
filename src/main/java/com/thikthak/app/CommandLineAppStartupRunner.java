...
import com.thikthak.app.acl.auth.repository.RoleRepository;
...
import com.thikthak.app.repository.system.SystemMenuRepository;
  ...
  //  UserLocationRepository userLocationRepository;
    ...
    public void createAppBasicUsers(){
        ...
        if(userSuperAdmin == null){
            ...
            userSuperAdmin.setUserType("Admin");
        ...
        if(roleSuperAdmin != null){
            ...
            if(userRoleInst == null){
                userRoleInst = new UserRole(null, userSuperAdmin, roleSuperAdmin, new Date(), "SYSTEM", null, null);
        ...
        if(roleAdmin != null){
            ...
            if(userRoleInst == null){
                userRoleInst = new UserRole(null, userAdmin, roleAdmin, new Date(), "SYSTEM", null, null);
                this.userRoleRepository.save(userRoleInst);
            }
        }
        ...
        if(roleGeneral != null){
            ...
            if(userRoleInst == null){
                userRoleInst = new UserRole(null, userGeneral, roleGeneral, new Date(), "SYSTEM", null, null);
                this.userRoleRepository.save(userRoleInst);
            }
        }
